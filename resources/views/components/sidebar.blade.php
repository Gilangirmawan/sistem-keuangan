...
<aside class="w-64 bg-gray-900 text-white flex flex-col">
    ...
    <nav class="flex-1 p-2 space-y-1">
        <a href="{{route('dashboard')}}" class="flex items-center gap-3 px-4 py-2 rounded bg-sky-500">
            <i class="fas fa-home"></i> Dashboard
        </a>
        <a href="{{ route('transaksi') }}" class="flex items-center gap-3 px-4 py-2 rounded hover:bg-gray-800">
