    ...
    <div class="relative overflow-x-auto shadow-md sm:rounded-lg">
        <table class="w-full text-sm text-left text-gray-500">
            ...
            <tbody>
                ...
                <tr>
                    <td colspan="8" class="text-center py-3">Belum ada data pemasukan.</td>
                </tr>
                @endif
            </tbody>
...
<div id="modalEdit" class="fixed inset-0 bg-black bg-opacity-50 hidden flex items-center justify-center">
    <div class="bg-white p-6 rounded-lg w-1/3 shadow-lg">
        <h3 class="text-lg font-semibold mb-4">Edit Data Pemasukan</h3>
...
<div id="modalDelete" class="fixed inset-0 bg-black bg-opacity-50 hidden flex items-center justify-center">
    <div class="bg-white p-6 rounded-lg w-1/3 shadow-lg">
        ...
        <p class="mb-4">Apakah anda yakin ingin menghapus pemasukan ini?</p>
